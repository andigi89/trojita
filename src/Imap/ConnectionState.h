...
typedef enum {
    ...
    CONN_STATE_CONNECTED_PRETLS, /**< @short Connection has been established and capabilities are known but TLS remains to be issued */
    CONN_STATE_STARTTLS_ISSUED, /**< @short The TLS command has been sent */
